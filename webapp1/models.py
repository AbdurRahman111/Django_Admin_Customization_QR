...
class Verifica_Risultati_Candidato(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        s = f"http://www.cvclitextranet.services/extranet/services/verificarisultaticandidato.aspx?mtr={self.MATRICOLA}"
        url = pyqrcode.create(s)
        url.png(f'qrcodes/{self.MATRICOLA}.png', scale=6)
        try:
            path = f"/home/kamypihx/kamyanasab/qrcodes/{self.MATRICOLA}.png"
